...
function RegisterLoginBox(props) {
      ...
      .then(async (userCredential) => {
        ...
        try {
          ...
          await addEntryWithId("users", user.uid, {
            ...
            username: "",
            handle: "", dateJoined: new Date().toLocaleString() + "", role: "user", tags: [], profilePic: ""
          })

          laraveLOG('User has registered with the following details: \n ' + JSON.stringify({
            email: email, password: password, username: "",
            handle: "", dateJoined: new Date().toLocaleString()
          }))
  ...
  const logInUser = async (email, password) => {
    ...
    try {
      ...
      setUser({
        username: userAcc.username, id: userAcc.id, handle:
          userAcc.handle, profilePic: userAcc.profilePic, dateJoined:
          userAcc.dateJoined, preferredTags: userAcc.tags, role: userAcc.role
      })

      laraveLOG('User has logged in with the following details: \n ' + JSON.stringify({
        id: userAcc.id, email: email, date: new Date().toLocaleString()
      }))
  ...
  return (
    <div className="overlay">
      ...
      <div className="flex-container">
        <div className="child">
          <Close className='close-icon login-close' style={{ fontSize: 30, display: "none" }} onClick={() => { navigate("/home") }} />
          ...
          {!registerMode ? <div className="login-form login-box">
            <div className='form'>
              <div className="input-container">
                <input ref={emailRef} type="text" name="username" id="username" placeholder=" " required pattern='email' />
                <label htmlFor="username">Email</label>
              </div>
              <div className="input-container">
                <input ref={pWordRef} type="password" name="pword" id="pword" placeholder=" " required />
            ...
            <div className="login-form login-box">
              <div className='form'>
                <div className="input-container">
                  <input ref={emailRef} type="text" name="username" id="username" placeholder=" " required />
                ...
                <div className="input-container">
                  <input ref={cWordRef} type="password" name="cword" id="cword" placeholder=" " required />
                ...
                <div className="login-row">
                  ...
                  <p className='regBtn'>Already a user?
                    <span onClick={(e) => { e.preventDefault(); setRegisterMode(false); }}>
                      Login Here
                    </span>
                  </p>
                </div>
        ...
        <div className="child banner">
          ...
          <div className='welcome-text'>
            ...
            <div className='text-desc'>
              <p>Connect with fellow gamers and discuss<br></br>your favorite games.</p>
            </div>
          </div>
